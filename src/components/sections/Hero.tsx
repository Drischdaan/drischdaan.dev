    ...
    <section id='hero' className='relative flex h-dvh flex-col px-10'>
      <div className='relative flex flex-1 flex-col items-center justify-center'>
        <div className='mb-2 flex flex-row items-center justify-center gap-2 rounded-lg border border-zinc-600 bg-neutral-950 px-3 py-1 text-orange-200 xl:mb-3 xl:px-4'>
          <h2 className='text-sm xl:text-base'>{`Greetings! I'm a`}</h2>
        </div>
        <div className='flex flex-row items-center justify-center gap-2'>
          <h1 className='text-zinc-500'>{'/* Hobby */'}</h1>
          <h1 className='relative text-5xl font-semibold uppercase md:text-6xl xl:text-7xl'>
        ...
        <div className='flex flex-row items-center justify-center gap-2'>
          ...
          <h1 className='text-zinc-500'>{'/* Job */'}</h1>
        </div>
        <h1 className='relative text-5xl font-semibold uppercase text-white md:text-6xl xl:text-7xl'>
          Developer.
        </h1>
      ...
      <div className='absolute right-[8%] top-[15%] hidden items-center justify-center xl:right-[15%] xl:top-1/4 xl:flex'>
        <CodeCard
          language='C++'
      ...
      <div className='absolute bottom-[15%] left-[10%] hidden items-center justify-center xl:bottom-1/4 xl:left-[20%] xl:flex'>
        <CodeCard
          language='Typescript'
