...
import { FiSlash, FiHeart } from 'react-icons/fi';
...
export default function Home() {
  ...
  return (
    <div className='w-full h-full'>
      ...
      {/* Home */}
      <div id='home' className="home-background w-screen sm:h-screen flex justify-center items-center flex-col-reverse md:flex-row relative">
        <Header />
      ...
      {/* About */}
      <div id='about' className='about-background w-screen h-screen'>
      ...
      {/* Contact */}
      <div id='contact' className='contact-background w-screen h-screen flex flex-col justify-end items-center'>
        ...
        {/* Footer */}
        <div className='flex-initial w-full p-3 flex justify-center items-center'>
          <div className='cursor-pointer group flex justify-center items-center gap-1 text-neutral-700 hover:text-neutral-100 transition-colors duration-300'>
            <span>Made with</span>
            <FiHeart className='text-red-900 fill-red-900 group-hover:text-red-600 group-hover:fill-red-600'/>
            <span>by drischdaan</span>
          </div>
        </div>
      </div>
